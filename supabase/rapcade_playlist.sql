...
-- This schema keeps `duration_seconds` as the source of truth and auto-generates `duration_label`
...
create or replace view public.rapcade_playlist_public
...
select position, title, duration_label, audio_url, cover_url
from public.rapcade_playlist_public
order by position;
